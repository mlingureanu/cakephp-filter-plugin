...
class FilteredBehavior extends Behavior
{
     ...
     * {@inheritDoc}
     *
     * @param array<mixed> $settings The configuration settings provided to this behavior.
     * @return void
     */
    public function initialize(array $settings)
    {
        ...
        $this->_filterValues[$this->getTable()->getAlias()] = [];
    }
     ...
     * @param array<mixed> $fieldOptions Field options.
     * @return void
     */
    protected function addFieldToFilter(Table $Table, Query $Query, $values, $field, $fieldOptions)
    {
        ...
        if (
            !isset($values[$configurationModelName][$configurationFieldName]) ||
            (
                empty($values[$configurationModelName][$configurationFieldName]) &&
                $values[$configurationModelName][$configurationFieldName] != 0
            )
        ) {
